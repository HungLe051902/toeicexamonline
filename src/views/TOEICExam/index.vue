      ...
      <div class="main-content mb-4">
        <div class="intro w-100 p-4">
          ...
          <p class="p-2 wrap text-left">
            TOEIC là một chứng chỉ được sử dụng phổ biến nhằm đánh giá trình độ
            sử dụng tiếng Anh trong môi trường giao tiếp quốc tế. Ở Việt Nam,
            chứng chỉ TOEIC là một trong những tiêu chuẩn phổ biến để đánh giá
            trình độ thông thạo tiếng Anh của người lao động được nhiều doanh
            nghiệp, tổ chức lựa chọn. Ngoài ra, TOEIC còn là chuẩn đầu ra tiếng
            Anh của nhiều trường đại học cho sinh viên khi tốt nghiệp. Bài thi
            toeic gồm 2 phần là phần đọc và phần nghe. Để giúp các bạn có mong
            muốn thi toeic có thể làm quen với đề thi trước khi thi thật. Nhóm
            chúng em có ý định xây dựng web thi thử toeic online. Các đề thi làm
            trên web đều được chấm điểm và có đáp án chi tiết để giúp các bạn có
            thể đánh giá chính xác nhất trình độ hiện tại của mình và có thể đưa
            ra kế hoạch luyện thi và học tập phù hợp.
          </p>
        </div>
          ...
          <div class="row">
            <div class="col-6">
              ...
              <p class="mb-0 text-left">
                ...
                doloremque quasi reprehenderit earum nisi a obcaecati
                asperiores, eos suscipit officiis veniam nostrum illo excepturi
                accusantium quidem eius cumque assumenda id.
              </p>
            </div>
            <div class="col-3">
              LINKS
  ...
  data() {
    return {
      ...
      listExam2020: [
        ...
        {
          name: "Đề số 2 - ETS 2020",
        },
        {
          name: "Đề số 3 - ETS 2020",
        },
        {
          name: "Đề số 4 - ETS 2020",
        },
        {
          name: "Đề số 5 - ETS 2020",
        },
        {
          name: "Đề số 6 - ETS 2020",
        },
        {
          name: "Đề số 7 - ETS 2020",
        },
        {
          name: "Đề số 8 - ETS 2020",
        },
        {
          name: "Đề số 9 - ETS 2020",
        },
        {
